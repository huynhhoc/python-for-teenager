...
while running:
    ...
    pygame.draw.circle(screen, (0, 0, 255), (WIDTH // 2, HEIGHT // 2 - 250), 10)  # Đông Chí
    pygame.draw.circle(screen, (255, 0, 0), (WIDTH // 2, HEIGHT // 2 + 250), 10)  # Hạ Chí

    # Add text for Đông Chí and Hạ Chí
    text_surface = font.render("Dong Chi - 21 hoac 22/12", True, (0, 0, 255))
    text_rect = text_surface.get_rect(center=(WIDTH // 2, HEIGHT // 2 - 270))
    screen.blit(text_surface, text_rect)
